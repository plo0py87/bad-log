          ...
          <div className="flex items-center">
            {post.author.avatar ? (
              <img
                ...
                className="w-10 h-10 rounded-none grayscale mr-3 border border-gray-800"
              />
            ) : (
              <div className="w-10 h-10 bg-black border border-gray-800 flex items-center justify-center mr-3">
            ...
            <div>
              <p className="font-light text-white">{post.author.name}</p>
              {post.author.bio && (
                <p className="text-sm text-white opacity-70">{post.author.bio}</p>
              )}
            </div>
          </div>
